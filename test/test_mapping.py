...
def test_sentry_is_armed_on_enabled_or_idle():
    """IDLE is what a secured, parked car reports with nothing happening — confirmed
    against a car the owner said was armed at the time. Only DISABLED is off."""
